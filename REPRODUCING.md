...
`s08` and `s09` did not complete on a machine with 8 GB of RAM; every other stage did.
...
python scripts/s09_run_oat_checks.py             # grid-side OAT               -> needed by s13
                                                  # REQUIRES s08: the LHS validation reads its
                                                  # 2026-08_final_lhs_uncertainty.csv before the OAT
...
python scripts/s23_summarise_variants.py                    # Tier-2, 2050, anchor-fitted, schedule, reinvestment and
                                                              ...
                                                              # REQUIRES s15 and s16: it reads their
                                                              # 2026-08-16_* per-settlement outputs by name.
